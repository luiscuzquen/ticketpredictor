...
class PrescottValley extends Component {
  ...
  price1Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice1,
      dPrice1: rPrice1 - (rPrice1 * prevState.percent1) / 100
    }));
  };
  ...
  percent1Change = evt => {
    ...
    this.setState(prevState => ({
      percent1,
      dPrice1: prevState.rPrice1 - (prevState.rPrice1 * percent1) / 100
    }));
  };
  ...
  price2Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice2,
      dPrice2: rPrice2 - (rPrice2 * prevState.percent2) / 100
    }));
  };
  ...
  percent2Change = evt => {
    ...
    this.setState(prevState => ({
      percent2,
      dPrice2: prevState.rPrice2 - (prevState.rPrice2 * percent2) / 100
    }));
  };
  ...
  price3Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice3,
      dPrice3: rPrice3 - (rPrice3 * prevState.percent3) / 100
    }));
  };
  ...
  percent3Change = evt => {
    ...
    this.setState(prevState => ({
      percent3,
      dPrice3: prevState.rPrice3 - (prevState.rPrice3 * percent3) / 100
    }));
  };
  ...
  price4Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice4,
      dPrice4: rPrice4 - (rPrice4 * prevState.percent4) / 100
    }));
  };
  ...
  percent4Change = evt => {
    ...
    this.setState(prevState => ({
      percent4,
      dPrice4: prevState.rPrice4 - (prevState.rPrice4 * percent4) / 100
    }));
  };
  ...
  price5Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice5,
      dPrice5: rPrice5 - (rPrice5 * prevState.percent5) / 100
    }));
  };
  ...
  percent5Change = evt => {
    ...
    this.setState(prevState => ({
      percent5,
      dPrice5: prevState.rPrice5 - (prevState.rPrice5 * percent5) / 100
    }));
  };
  price6Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice6,
      dPrice6: rPrice6 - (rPrice6 * prevState.percent6) / 100
    }));
  };
  ...
  percent6Change = evt => {
    ...
    this.setState(prevState => ({
      percent6,
      dPrice6: prevState.rPrice6 - (prevState.rPrice6 * percent6) / 100
    }));
  };
  price7Change = evt => {
    ...
    this.setState(prevState => ({
      rPrice7,
      dPrice7: rPrice7 - (rPrice7 * prevState.percent7) / 100
    }));
  };
  ...
  percent7Change = evt => {
    ...
    this.setState(prevState => ({
      percent7,
      dPrice7: prevState.rPrice7 - (prevState.rPrice7 * percent7) / 100
    }));
  };
